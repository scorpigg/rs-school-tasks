...
export class CarDrive extends Render {
  private startBtn: Render;

  private stopBtn: Render;

  private carImg!: Render;

  private finishImg: Render;

  constructor(parentNode: HTMLElement, carColor: string) {
    super(parentNode, 'div', ['car-drive'], '');
    this.startBtn = new Render(this.element, 'button', ['start-btn'], 'Start');
    ...
    this.carImg.element.innerHTML = `<svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="80px" height="45px" viewBox="30 0 260.018 217.017">
       ...
       <path fill="${carColor}" d="M52.17,195.175c3.638,5.379,9.794,8.922,16.756,8.922c0.228,0,0.44-0.062,0.663-0.073c2.576-0.083,5.043-0.61,7.291-1.574
       ...
       <path fill="${carColor}" d="M269.755,209.068c2.656,0,5.173-0.549,7.503-1.481c1.589-0.642,3.06-1.491,4.422-2.495
